...
if ( ! function_exists( 'aurelia_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function aurelia_posted_on() {
...
if ( ! function_exists( 'aurelia_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'aurelia_entry_footer' ) ) :
	...
	function aurelia_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'aurelia' ) );
			if ( $tags_list ) {
...
if ( ! function_exists( 'aurelia_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function aurelia_post_thumbnail() {
